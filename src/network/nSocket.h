...
class PermanentError: public tException
    ...
    inline tSocket             GetSocket( void )         const; //!< Gets the raw socket
    inline nSocket const & GetSocket( tSocket & socket ) const;	//!< Gets the raw socket
...
private:
    ...
    inline nSocket & SetSocket( tSocket socket );	       //!< Sets the raw socket

    tSocket socket_;            //!< the raw socket
...
tSocket nSocket::GetSocket( void ) const
{
    return this->socket_;
}
...
nSocket const & nSocket::GetSocket( tSocket & socket ) const
{
    socket = this->socket_;
    return *this;
}
...
nSocket & nSocket::SetSocket( tSocket socket )
{
    this->socket_ = socket;
    return *this;
}
