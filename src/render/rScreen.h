...
//! draw a bright plate behind dark text instead of brightening the glyphs
extern bool sr_darkTextPlate;
...
//! The name the desktop sees: window title, task bar entry, and what Discord
//! reads off a running window when it decides what is being played. The name
//! in the language file belongs to the engine and stays where it is.
char const * sr_ClientName();

//! Reverse domain form of the same thing, for the window class and the
//! desktop entry that has to match it.
