...
int sn_defaultDelay=1000; // OPTIMIZATION: was 10000 (10ms), now 1ms — faster packet processing
...
int sn_maxRateIn=128; // OPTIMIZATION: was 32 — prevents throttling on modern connections
int sn_maxRateOut=64; // OPTIMIZATION: was 16 — allows faster input packet delivery
