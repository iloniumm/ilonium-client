...
define(PROGTITLE,Retrocycles) 
dnl define(PROGNAME,[Retrocycles(-dedicated)]) 
define(PROGNAMEBASE,Retrocycles) 
...
ifelse(DOCSTYLE,web,
[define(PROGNAME,[Retrocycles(-dedicated)])]
,
[
ifelse(DEDICATED,,
[define(PROGNAME,[Retrocycles-dedicated])],
[define(PROGNAME,[Retrocycles])]
)
]
)
