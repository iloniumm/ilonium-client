...
public:
    ...
    // demo player sync setters
    void SetAliveState(short state) { alive_ = state; }
    void SetDirDrive(const eCoord& d) { dirDrive = d; }
    void SetSpeedState(REAL speed) { verletSpeed_ = speed; acceleration = 0.0f; }
