...
// Set by DoCenterDisplay, consumed by HudManager each frame
std::string g_modCenterText = "";
double      g_modCenterTextExpiry = 0.0;  // tSysTimeFloat() when it expires
float       g_modCenterTextR = 1.0f, g_modCenterTextG = 1.0f, g_modCenterTextB = 1.0f;
