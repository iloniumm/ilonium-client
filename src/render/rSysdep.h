...
public:
    ...
    // Overlay callback: called after all per-frame tasks but before buffer swap
    typedef void (*OverlayRenderFunc)();
    static OverlayRenderFunc overlayRenderFunc_;
    static void SetOverlayRenderer(OverlayRenderFunc func) { overlayRenderFunc_ = func; }
};
