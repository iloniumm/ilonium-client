...
public:
    ...
    int GetCurrentTop() const { return currentTop; }
    void SetCurrentTop(int top) { currentTop = top; }
    double GetLastCustomTimeout() const { return lastCustomTimeout; }
    void SetLastCustomTimeout(double t) { lastCustomTimeout = t; }
...
// [MOD] Center message data — set by rConsole::DoCenterDisplay, read by HudManager ImGui overlay
#include <string>
