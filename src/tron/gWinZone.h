...
//! Making the zone look lit rather than merely present. Local only.
extern bool sg_zoneGlow;
extern REAL sg_zoneGlowStrength;
extern bool sg_zoneGlowOwnWhite;
...
public:
    ...
    gRealColor const & GetColor() const { return color_; }
protected:
